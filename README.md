...
| 🗺️ 研究方案 | 把构想组织成「研究目标—研究内容—关键科学问题—技术路线（含 Mermaid 图）—可行性—年度计划—预期成果」 |
| 🧱 研究基础 | 2026 正文三板块之一：把你的前期积累整理成规范「研究基础」，**只组织你提供的事实、绝不编造成果** |
...
> 📌 **2026 申请书改版提示**：自 2026 年起，面上/青年科学基金（C 类）申请书正文调整为
> **「立项依据 / 研究内容 / 研究基础」三部分**，正文篇幅**原则上不超过 30 页**（"瘦身提质"，研究内容
> 不再预设固定提纲、鼓励自主组织）；并以**不超过 5 项代表性研究成果（代表作）+ 本人贡献说明**替代传统论文论著目录。
> 工作台汇总会按正文章节估算页数并提示 30 页红线，自查清单含相应提醒。**具体以当年项目指南与申请书模板为准。**
